...
###H1.3: There is an interaction effect: Female leaders are more discriminative as to their followers gender than male leaders are
```{r H1.3 of model_1}

#H1.3 of model_1
hypothesis(model_1, "(Leader_genderMale:Follower_genderMale - Leader_genderMale:Follower_genderFemale) < (Leader_genderFemale:Follower_genderMale - Leader_genderFemale:Follower_genderFemale)")
...
###H2.3: There is an interaction effect: Female leaders are more discriminative as to their followers gender than male leaders are
```{r H2.3 of model 2}

#H2.3 of model 2
hypothesis(model_2, "(Leader_genderMale:Follower_genderMale - Leader_genderMale:Follower_genderFemale) < (Leader_genderFemale:Follower_genderMale - Leader_genderFemale:Follower_genderFemale)")
...
###H1.1: There is an effect of leader in relation to gender: male leaders tend to surrender less than female leaders
```{r plot of H1.1}
H1.1 <- ggplot(data_db, aes(x = Leader_gender, y = leader_behavior, fill = Leader_gender)) +
  labs(x = "Leader gender", y = "Predicted propensity to surrender", title = "H1.1") +
  geom_boxplot(aes(x = Leader_gender, Estimate) , data = pred_1, width = 0.5) + 
  theme(legend.position = "none", panel.grid.minor = element_blank()) + 
  geom_violin(aes(x = Leader_gender, y = Estimate), data = pred_1, trim = FALSE, width =1, alpha = 0.1) + 
...
##H1.2: There is an effect of follower in relation to gender: leaders tend to surrender more to men than to women
```{r plot of H1.2}
H1.2 <- ggplot(data_db, aes(x = Follower_gender, y = leader_behavior, fill = Follower_gender)) +
  labs(x = "Follower gender", y = "Predicted propensity to surrender", title = "H1.2") +
  geom_boxplot(aes(x = Follower_gender, Estimate) , data = pred_1, width = 0.5) + 
  theme(legend.position = "none", panel.grid.minor = element_blank()) + 
  geom_violin(aes(x = Follower_gender, y = Estimate), data = pred_1, trim = FALSE, width =1, alpha = 0.1) + 
  scale_y_continuous(breaks = sort(c(seq(min(pred_1$Estimate), max(pred_1$Estimate), length.out=5), 0.5))) + 
  geom_hline(yintercept= 0.5, color = "black", linetype = "dashed", alpha = 0.8) + 
  scale_fill_manual(values=c("orange", "blue")) +
  theme(plot.title = element_text(hjust = 0.5))+ 
...
###H1.3: There is an interaction effect: Female leaders are more discriminative as to their followers gender than male leaders are, i.e. for female leaders, the gender of the follower makes a larger difference to their decision than it does for male leaders.
```{r plot of H1.3}
H1.3 <- ggplot(pred_1, aes(x = Leader_gender, y = Estimate, fill = Follower_gender)) + 
...
H2.1 <- ggplot(data_db, aes(x = Leader_gender, y = leader_behavior, fill = Leader_gender)) +
  labs(x = "Leader gender", y = "Predicted propensity to surrender", title = "H2.1") +
  geom_boxplot(aes(x = Leader_gender, Estimate) , data = pred_2, width = 0.5) + 
  theme(legend.position = "none", panel.grid.minor = element_blank()) + 
  geom_violin(aes(x = Leader_gender, y = Estimate), data = pred_2, trim = FALSE, width =1, alpha = 0.1) + 
...
H2.2 <- ggplot(data_db, aes(x = Follower_gender, y = leader_behavior, fill = Follower_gender)) +
  labs(x = "Follower gender", y = "Predicted propensity to surrender", title = "H2.2") +
  geom_boxplot(aes(x = Follower_gender, Estimate) , data = pred_2, width = 0.5) + 
  theme(legend.position = "none", panel.grid.minor = element_blank()) + 
  geom_violin(aes(x = Follower_gender, y = Estimate), data = pred_2, trim = FALSE, width =1, alpha = 0.1) + 
  scale_y_continuous(breaks = sort(c(seq(min(pred_2$Estimate), max(pred_2$Estimate), length.out=5), 0.5))) + 
  geom_hline(yintercept= 0.5, color = "black", linetype = "dashed", alpha = 0.8) + 
  scale_fill_manual(values=c("orange", "blue"))  + 
  theme(text = element_text(size=20))
...
###H2.3: There is an interaction effect: Female leaders are more discriminative as to their followers gender than male leaders are, i.e. for female leaders, the gender of the follower makes a larger difference to their decision than it does for male leaders.
```{r plot of H2.3}
H2.3 <- ggplot(pred_2, aes(x = Leader_gender, y = Estimate, fill = Follower_gender)) + 
