...
```{r}
#Subset to left data
data_left <- subset(data, select = c(GroupNumber, unique_ID_left, dif_blue, dif_blue_abs, chosen_leader, Leader_gender, Follower_gender, skill_dif, confidence_left, leader_behaviour, Sensitivity_roll_left, Gender_left, left_answer)) #take all data for left participant
...
```{r}
#Subset right data
data_right <- subset(data, select = c(GroupNumber, unique_ID_right, dif_blue, dif_blue_abs, chosen_leader, Leader_gender, Follower_gender, skill_dif, confidence_right, leader_behaviour, Sensitivity_roll_right, Gender_right, right_answer)) #Subsetting right data
