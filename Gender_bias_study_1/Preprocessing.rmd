...
##Saving estimats from sensitivity
```{r}
...
pooling_individual$Intercept_ranef_fixef_estimate <- pooling_individual_ranef[, 1] + pooling_individual_fixef[1, 1] #Adding fixef of intercept to ranef of intercept

pooling_individual$Slope_ranef_fixef_estimate <- pooling_individual_ranef[, 3] + pooling_individual_fixef[1, 2] #Adding fixef of slope to ranef of slope
