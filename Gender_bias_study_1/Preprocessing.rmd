...
#rename columns
data$right_answer <- data$Response_right
data$left_answer <- data$Response_left

#delete Response_right and Reponse_left
data <- select(data, -c(Response_left, Response_right))
